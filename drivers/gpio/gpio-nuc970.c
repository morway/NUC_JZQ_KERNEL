					 ...
					 unsigned gpio_num)
{
 ...
 EXPORT_SYMBOL(nuc970_gpio_core_direction_in1);
 ...
 int nuc970_gpio_core_get(struct gpio_chip *gc, unsigned gpio_num)
{
	int port_num, value;
	const struct gpio_port *port;
 ...
 int nuc970_gpio_core_get1( unsigned gpio_num)
{
 ...
 EXPORT_SYMBOL(nuc970_gpio_core_get1);
...
static int nuc970_gpio_core_set(struct gpio_chip *gc,unsigned gpio_num,
				  int val)
{
	int port_num, value;
	const struct gpio_port *port =
  ...
  int nuc970_gpio_core_set1(unsigned gpio_num,int val)
{
 ...
 EXPORT_SYMBOL(nuc970_gpio_core_set1);
					  ...
					  unsigned gpio_num, int val)
{
	...
	__raw_writel(value, port->dir);
	spin_unlock(&gpio_lock);
	nuc970_gpio_core_set( 0,gpio_num, val);
...
int nuc970_gpio_core_direction_out1(unsigned gpio_num, int val)
{
	...
	__raw_writel(value, port->dir);
	spin_unlock(&gpio_lock);
   nuc970_gpio_core_set1(gpio_num, val);

	return 0;
}

EXPORT_SYMBOL(nuc970_gpio_core_direction_out1);
...
static int nuc970_gpio_core_to_request(struct gpio_chip *chip, unsigned offset)
{
 ...
 EXPORT_SYMBOL(nuc970_gpio_core_to_request1);
